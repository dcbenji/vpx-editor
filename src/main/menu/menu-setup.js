...
export function insertItem(itemType, deps) {
      ...
      submenu: [
        {
          ...
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Wall', deps),
        },
        {
          label: 'Gate',
          accelerator: 'CmdOrCtrl+G',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Gate', deps),
        },
        {
          label: 'Ramp',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Ramp', deps),
        },
        {
          label: 'Flasher',
          accelerator: 'CmdOrCtrl+H',
          enabled: hasTable && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Flasher', deps),
        },
        {
          label: 'Flipper',
          accelerator: 'CmdOrCtrl+F',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Flipper', deps),
        },
        {
          label: 'Plunger',
          accelerator: 'CmdOrCtrl+P',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Plunger', deps),
        },
        {
          label: 'Bumper',
          accelerator: 'CmdOrCtrl+B',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Bumper', deps),
        },
        {
          label: 'Spinner',
          accelerator: 'CmdOrCtrl+I',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Spinner', deps),
        },
        {
          label: 'Timer',
          accelerator: 'CmdOrCtrl+M',
          enabled: hasTable && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Timer', deps),
        },
        {
          label: 'Trigger',
          accelerator: 'CmdOrCtrl+T',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Trigger', deps),
        },
        {
          label: 'Light',
          accelerator: 'CmdOrCtrl+L',
          enabled: hasTable && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Light', deps),
        },
        {
          label: 'Kicker',
          accelerator: 'CmdOrCtrl+K',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Kicker', deps),
        },
        {
          label: 'Target',
        ...
        },
        {
          ...
          enabled: hasTable && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Decal', deps),
        },
        {
          label: 'Textbox',
          accelerator: 'CmdOrCtrl+E',
          enabled: hasTable && inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Textbox', deps),
        },
        {
          label: 'EM Reel',
          accelerator: 'CmdOrCtrl+Y',
          enabled: hasTable && inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Reel', deps),
        },
        {
          label: 'Light Sequencer',
          accelerator: 'CmdOrCtrl+Q',
          enabled: hasTable && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('LightSequencer', deps),
        },
        {
          label: 'Primitive',
          accelerator: 'CmdOrCtrl+J',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Primitive', deps),
        },
        {
          label: 'Rubber',
          accelerator: 'CmdOrCtrl+U',
          enabled: hasTable && !inBackglass && !isLocked && !dialogOpen,
          click: (m, w) => windowRegistry.getByWindow(w) && insertItem('Rubber', deps),
        },
      ],
    },
    {
